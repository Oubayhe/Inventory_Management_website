...
$get_products_for_respo = "SELECT 
    ...
    JOIN responsables res ON res.id_responsable = rbe.id_responsable
    ...
    WHERE rbe.id_request_employee  = $id_request_employee";
...
$get_products_sum = "SELECT SUM(quantity) AS total_quantity
                     FROM products
   ...
   <div class="big-container">
        ...
        <div class="main-page">
            ...
            <div class="request-box">
                <form action="traiter_modifier_emp.php" method="post">
                    <table>
                        <tbody>
                            <tr>
                                <th>Produit:</th>
