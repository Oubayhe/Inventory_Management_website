...
WHERE id_responsable_receving  = $id_responsable AND rbr.processing_status = 0
...
<body>
    ...
    <div class="big-container">
        ...
        <div class="main-page">
            ...
            <h2 class="titre-page">Les demandes envoyée par des responsables</h2>
            <table>
                <thead>
                    <tr>
                        <th>Produit</th>
                ...
                <tbody>
                    ...
                    while($data_PFR = mysqli_fetch_assoc($link_products_for_respo)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $data_PFR['last_name']." ".$data_PFR['first_name'] ?></td>
                            ...
                            <td>
                                ...
                                <form id="form_rbr" action="traiter_processing_status.php" method="post">
                                    ...
                                    <input type="hidden" name="id_demande" value="<?php echo $data_PFR['id_request_respo']; ?>">
