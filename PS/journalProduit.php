    ...
    <div class="big-container">
        ...
        <div class="main-page">
            ...
            <h3 class="welcomeMessage">
                Suivre le mouvement du produit, son origine et sa destination
            </h3>
            <!-- Down here we have the table -->
            <h2 class="titre-page">Mouvements des produits</h2>
            ...
            <table>
                ...
                WHERE
                    p.id_responsable = $id_responsable 
                GROUP BY
                    p.id_product_ref
                ORDER BY
                    id_product DESC";
                    ...
                    while($data_products = mysqli_fetch_assoc($link_products)){
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="seeHistoryPrt.php" method="post">
                                    <input type="hidden" name="idProduct" value="<?php echo $data_products['id_product_ref']?>">
                                    <button class="icon-chart" name="voirHis" type="submit"><i class="fa-solid fa-book"></i></button>
                                </form>
                            </td>
                        </tr>
                        <?php
